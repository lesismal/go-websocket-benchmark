...
require (
	...
	github.com/go-netty/go-netty-ws v0.0.0-20230619104314-e65544ee576a
	...
	github.com/lxzan/gws v1.6.1-alpha2
...
require (
	...
	github.com/go-netty/go-netty-transport v1.6.4 // indirect
